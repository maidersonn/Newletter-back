...
export declare const createPool: (clientConfiguration?: ClientConfigurationInput) => {
    ...
    connect: <T>(connectionRoutine: import("../../src/types").ConnectionRoutine<T>) => Promise<T>;
    ...
    transaction: <T_1>(handler: import("../../src/types").TransactionFunction<T_1>, transactionRetryLimit?: number | undefined) => Promise<T_1>;
};
