...
export declare type TypeNameIdentifier = 'bool' | 'bytea' | 'float4' | 'float8' | 'int2' | 'int4' | 'int8' | 'json' | 'text' | 'timestamptz' | 'uuid';
...
export declare type UnnestSqlColumn = string | readonly string[];
...
export declare type SqlToken = ArraySqlToken | BinarySqlToken | IdentifierSqlToken | JsonSqlToken | ListSqlToken | SqlSqlToken | UnnestSqlToken;
...
export declare type SqlTaggedTemplate<T extends UserQueryResultRow = QueryResultRow> = {
    ...
    unnest: (tuples: ReadonlyArray<readonly any[]>, columnTypes: readonly UnnestSqlColumn[]) => UnnestSqlToken;
};
